...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* HEADER FLUTUANTE ULTRA-INTUITIVO */
        header {
        ...
        /* COMPOSIÇÃO NATIVA DA SUA LOGO (JP JOTAPE MARKETING) */
        .logo-container {
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /* SEÇÃO HERO: ENTRADA IMPACTANTE E DIRETA */
        .hero {
            min-height: 100vh;
        ...
        /* EMBLEMA CENTRALIZADO COM SUA LOGO NO CORPO DO SITE */
        .hero-emblema-logo {
            width: 90px;
            height: 90px;
            background-color: #070d19;
        ...
        /* ABA: NOSSOS SERVIÇOS (Direto e sem excessos) */
        ...
        /* ADAPTAÇÃO TOTAL PARA DISPOSITIVOS MÓVEIS (RESPONSIVIDADE) */
        @media (max-width: 968px) {
            .bloco-grid { grid-template-columns: 1fr; gap: 40px; }
            .hero h1 { font-size: 35px; }
            .hero p { font-size: 16px; }
            header { padding: 15px 5%; }
            nav { display: none; } /* Mapeamento limpo em dispositivos móveis */
...
<body>
    ...
    <section class="quem-somos" id="quem-somos">
        ...
        <div class="bloco-grid">
            <div class="conteudo-texto">
                ...
                <p>A <strong>Jotapemartking</strong> nasceu da necessidade de entregar resultados palpáveis no mercado digital. Nós não somos uma agência tradicional focada apenas em curtidas ou métricas estéticas. Somos estrategistas comerciais que utilizam a internet como uma ferramenta de multiplicação de receita.</p>
                <p>Nossa equipe une inteligência analítica e excelência criativa para desenhar funis de conversão automatizados, tráfego pago de alta performance e design sofisticado. Cuidamos do posicionamento da sua empresa para que você passe o máximo de credibilidade e consiga cobrar o valor justo que seu produto ou serviço realmente vale.</p>
            </div>
    ...
    <section class="alavancagem" id="alavancar">
        <div class="header-secao">
            ...
            <p>Acelere o passo e pare de perder faturamento para concorrentes menos qualificados.</p>
        </div>

        <div class="texto-propaganda">
            <h3>🔥 O Seu Próximo Nível Comercial Começa Aqui:</h3>
            <p>A verdade nua e crua é que se a sua empresa não aparece com relevância no digital, ela simplesmente não existe para a parcela de clientes que mais consome. Estar na internet de forma amadora é pior do que estar fora dela — afasta quem tem alto poder de compra.</p>
            <p>A <strong>Jotapemartking</strong> alavanca o seu negócio através de uma <strong>Engenharia de Desejo</strong>. Nós analisamos friamente o seu mercado, identificamos as maiores brechas deixadas pelos seus concorrentes diretos e implementamos anúncios patrocinados cirúrgicos. Isso significa colocar o seu produto na tela de milhares de pessoas locais altamente qualificadas exatamente no momento em que elas precisam da sua solução.</p>
            <p>Nós blindamos a sua comunicação, otimizamos o seu funil de captação e direcionamos os leads qualificados direto para o seu time de vendas, poupando seu tempo e multiplicando o seu faturamento.</p>
        </div>

        <div class="pilares-estrategicos">
            <div class="pilar-card">
                <i class="fas fa-search-dollar"></i>
                <h4>Análise de Mercado Oculta</h4>
                <p>Estudamos os pontos fracos dos seus concorrentes para posicionar sua marca como a escolha óbvia e dominante.</p>
            </div>
            <div class="pilar-card">
                <i class="fas fa-funnel-dollar"></i>
                <h4>Funis Automáticos de Captação</h4>
                <p>Estruturamos caminhos digitais inteligentes para que o cliente tenha interesse e entre em contato rápido.</p>
            </div>
            <div class="pilar-card">
                <i class="fas fa-chart-line"></i>
                <h4>Escala Sem Limites</h4>
                <p>Criamos campanhas otimizadas para crescer conforme o seu estoque e capacidade de atendimento aumentam.</p>
            </div>
        </div>
    </section>
    ...
    <section class="servicos" id="servicos">
        <div class="header-secao">
            ...
            <p>Foco máximo naquilo que traz dinheiro para o caixa. Sem excessos, sem distrações.</p>
        </div>
        ...
        <div class="grid-servicos">
            <div class="card-servico">
                ...
                <p>Criamos, configuramos e gerenciamos campanhas de anúncios patrocinados no Meta Ads e Google Ads direcionados para o seu público-alvo ideal.</p>
                <ul>
                    <li><i class="fas fa-check"></i> Segmentação avançada por localização</li>
                    <li><i class="fas fa-check"></i> Criação de criativos focados em conversão</li>
                    <li><i class="fas fa-check"></i> Monitoramento diário de métricas e ROI</li>
                </ul>
            </div>
            ...
            <div class="card-servico">
                ...
                <p>Elevamos a percepção visual da sua marca corporativa nas redes sociais, transmitindo máxima credibilidade e gerando desejo real de compra.</p>
                <ul>
                    <li><i class="fas fa-check"></i> Identidade visual exclusiva para redes</li>
                    <li><i class="fas fa-check"></i> Design de posts carrosséis profissionais</li>
                    <li><i class="fas fa-check"></i> Padronização estética de alta autoridade</li>
                </ul>
            </div>
            ...
            <div class="card-servico">
                ...
                <p>Desenvolvemos textos, roteiros de vídeos e legendas altamente persuasivas utilizando gatilhos psicológicos para quebrar objeções de vendas.</p>
                <ul>
                    <li><i class="fas fa-check"></i> Roteiros dinâmicos para Reels e Stories</li>
                    <li><i class="fas fa-check"></i> Redação focada em chamadas de ação fortes</li>
                    <li><i class="fas fa-check"></i> Alinhamento de discurso focado no cliente ideal</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="cta-final">
        <div class="cta-container">
            ...
            <p>Não continue deixando dinheiro na mesa. Fale com um especialista da Jotapemartking e descubra o plano exato ideal para as necessidades comerciais do seu negócio.</p>
